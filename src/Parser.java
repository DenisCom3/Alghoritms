...
// Оптимизировать код swichом, проверить работу, еще раз для гисметео, GIT   think about connecting with telegramBot
public class Parser {
    ...
    public static void main(String[] args) throws Exception {
        ...
        for (Element name : names) {
            ...
            int itterationCount =  PrintForValues(values, index);
            index = index + itterationCount;
        }
